...
| 2026-08-18 | Tier 0 direct EC2 public HTTPS activation | 依已核准 Batch 6A，以目前 public IPv4 申請 Let's Encrypt short-lived IP certificate，切換 production runtime 與固定 IP Nginx，啟用 12 小時 renewal timer；未建立 Route 53、ACM、CloudFront、ALB、EIP 或 NAT | Enable script 回報成功；application／public Nginx／renew timer active；EC2 內 HTTPS readiness HTTP `200`；尚待外部 Browser 與負面邊界驗證 | [Public HTTPS R3 readiness](evidence/2026-08-18-tier0-public-https/tdd-validation.md) |
