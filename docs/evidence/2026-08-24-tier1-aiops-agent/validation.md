...
- Residual risk：replacement 已部署並通過 zero-model gate，但尚未以 forced-tool 版本取得有效真實分析；舊 marker 必須保留。新的 bounded Nova Lite invocation 需另行核准，且在有效分析、人工批准與受控 recovery action完成前，不宣稱 AIOps AWS Demo 完成。
