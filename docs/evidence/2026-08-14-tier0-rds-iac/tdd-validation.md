...
Console 證據：[`RDS change set only`](../../screenshots/phase0-tier0-rds-change-set.png)、[`空白參數 rollback`](../../screenshots/phase0-tier0-rds-parameter-validation-failure.png)、[`EngineVersion rollback`](../../screenshots/phase0-tier0-rds-engine-version-failure.png)。
